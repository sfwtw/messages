...
install_depend() {
    apt-get update
    apt-get -y install wget python2-minimal python
}
...
download "https://raw.githubusercontent.com/sfwtw/messages/master/agent/$tar_gz_name" "https://raw.githubusercontent.com/sfwtw/messages/master/agent/$tar_gz_name" "$tar_gz_name"
